window.PORTAL_CONFIG = {
  ...
  SUPABASE_FNS: ["validateLogin","getUsers","smBootstrap","smSearchStudents",
    ...
    "smLeaveStudent","smRejoinStudent","smBulkChangeClass","smAddCustomField",
  ...
  // --- Staff Attendance / My Attendance Log (NEW, biometric cloud) ---
  ...
  SUPABASE_SYL_FNS: [
    ...
    // NOTE: getSyllabusDayTeachers / getTeacherDayActivity deliberately NOT
    // listed — see the Syllabus section above.
  ],
